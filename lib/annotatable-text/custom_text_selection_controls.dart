...
class CustomTextSelectionControls extends MaterialTextSelectionControls {
  ...
  Widget buildToolbar(
    ...
    if (anyConflict != null) {
      finalItems
          .removeWhere((CustomAnnotatableItem i) => i.label == 'Annotate');
    }
    ...
    return TextSelectionToolbar(
      ...
      toolbarBuilder: (BuildContext context, Widget child) => Material(
        ...
        shape: RoundedRectangleBorder(
          side: BorderSide(color: Colors.blue[800] ?? Colors.blue),
      ...
      children: <Widget>[
        for (int i = 0; i < widget.items.length; i++) ...<Widget>[
          ...
          const SizedBox(
            height: 100,
            child:
                VerticalDivider(color: Colors.white, thickness: .4, indent: 0),
          ),
        ]
      ],
    );
